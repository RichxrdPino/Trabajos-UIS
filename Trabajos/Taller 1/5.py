...
# Verificar si la base es 2, 4 u 8
...
# En caso de que la base sea Hexadecimal    
    ...
    while n > 0:
        ...
        # Si el módulo es menor a 10, agregar el número a la izquierda de lo que llevamos
        if r < 10:
            hexa = str(r) + hexa
        # Si el módulo es de 10 hasta 15, agregar las letras A hasta F respectivamente
        elif r == 10:
            hexa = "A" + hexa
        elif r == 11:
            hexa = "B" + hexa
            ...
            hexa = "F" + hexa
        n = z // b # Dividir z entre b y guardar el valor en n
